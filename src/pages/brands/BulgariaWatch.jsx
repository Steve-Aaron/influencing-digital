...
const BRAND = {
  ...
  description: 'An independent platform monitoring Bulgarian media, politics, and society with rigorous, evidence-based analysis. A reference platform built to understand stories, not to break them first.',
  about1: 'Bulgaria Watch was built for readers who have noticed that the Bulgarian media landscape produces a great deal of noise and a relatively small amount of clarity. The platform monitors political developments, media narratives, and social trends; its purpose is to make the existing volume legible rather than to add to it.',
