...
const BRAND = {
  ...
  description: 'People of Bulgaria tells the stories of the people who actually live there. Not their institutions, their politicians, or their problems; their lives. Ordinary lives across the country and the diaspora, told in enough detail to be worth reading.',
  about1: 'People of Bulgaria was built on the observation that most coverage of the country focuses on its institutions, its politicians, and its problems. Almost none of it focuses on the people who actually live there. The platform is a deliberate correction: long-form portrait journalism that takes its subjects seriously and gives them room to speak in their own words.',
  about2: 'The format is simple. Each story follows one person or one community, in enough depth that the reader comes away with a genuine sense of what their life looks like and what they think about it. The cumulative effect is something closer to a social portrait of the country than any polling or official data could provide. It captures the things that numbers are not designed to measure.',
  pillars: [
    {
